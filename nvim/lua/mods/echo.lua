...
function M.setup()
  ...
  vim.api.nvim_set_hl(0, "StatuslineNormalActive", { fg = palette.bg0, bg = palette.filled_blue })
  vim.api.nvim_set_hl(0, "StatuslinePillNormalActive", { fg = palette.filled_blue, bg = palette.bg1 })
  vim.api.nvim_set_hl(0, "StatuslineNormalInvertedActive", { fg = palette.filled_blue, bg = palette.bg0 })
  ...
  vim.api.nvim_set_hl(0, "StatuslineInsertActive", { fg = palette.bg0, bg = palette.filled_green })
  vim.api.nvim_set_hl(0, "StatuslinePillInsertActive", { fg = palette.filled_green, bg = palette.bg1 })
  vim.api.nvim_set_hl(0, "StatuslineInsertInvertedActive", { fg = palette.filled_green, bg = palette.bg0 })
  ...
  vim.api.nvim_set_hl(0, "StatuslineReplaceActive", { fg = palette.bg0, bg = palette.filled_red })
  vim.api.nvim_set_hl(0, "StatuslinePillReplaceActive", { fg = palette.filled_red, bg = palette.bg1 })
  vim.api.nvim_set_hl(0, "StatuslineReplaceInvertedActive", { fg = palette.filled_red, bg = palette.bg0 })
